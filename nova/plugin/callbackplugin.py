...
class _CallbackNotifier(object):
    ...
    For each NovaPlugin, a CallbackNotifier will be added to the
...
class CallbackPlugin(plugin.Plugin):
    ...
    def add_callback(self, callback, event_type, user_data=None):
        ...
        An alternative to implementing a fullblown notify notifier,
        sets up a function for a single event type.
        """
